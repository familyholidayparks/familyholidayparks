...
function initMap() {{
  ...
  <div style="display:flex;align-items:center;gap:7px;padding:7px 10px 7px 7px;background:white;border-radius:100px;box-shadow:0 2px 8px rgba(0,0,0,0.18);cursor:pointer;transition:all 0.15s;max-width:200px;">
    ${{park.photo
      ...
      : `<div style="width:28px;height:28px;border-radius:50%;background:#f0f0f0;flex-shrink:0;"></div>`
    }}
    <div style="min-width:0;">
      <div style="font-size:11px;font-weight:600;color:#222;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:130px;font-family:DM Sans,sans-serif;">${{park.name.replace(/Holiday Park|Tourist Park|Caravan Park/g,'').trim()}}</div>
      <div style="font-size:11px;color:#0072CE;font-weight:700;font-family:DM Sans,sans-serif;">${{park.score_label}}</div>
    </div>
  </div>
`;
